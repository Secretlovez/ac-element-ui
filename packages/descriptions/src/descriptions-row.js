export default {
  ...
  render(h) {
    ...
    if (elDescriptions.direction === 'vertical') {
      return (
        <tbody>
          <tr class='ac-descriptions-row'>
            {row.map((item) => {
              return (
                <th
                  class={{
                    'ac-descriptions-item__cell': true,
                    'ac-descriptions-item__label': true,
          ...
          <tr class='ac-descriptions-row'>
            {row.map((item) => {
              return (
                <td
                  class={[
                    'ac-descriptions-item__cell',
                    'ac-descriptions-item__content',
      ...
      <tbody>
        <tr class='ac-descriptions-row'>
          {row.map((item) => {
            return (
              <td
                class='ac-descriptions-item ac-descriptions-item__cell'
                colSpan={item.props.span}
              >
                <div class='ac-descriptions-item__container'>
                  <span
                    class={{
                      'ac-descriptions-item__label': true,
