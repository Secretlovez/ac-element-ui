...
import { isFunction } from '@syhr/ac-element-ui/src/utils/types';
...
export default {
  ...
  render() {
    ...
    return (
      <div class='ac-descriptions'>
        {title || extra || $slots.title || $slots.extra ? (
          <div class='ac-descriptions__header'>
            <div class='ac-descriptions__title'>
              {$slots.title ? $slots.title : title}
            </div>
            <div class='ac-descriptions__extra'>
              {$slots.extra ? $slots.extra : extra}
            </div>
          </div>
        ) : null}

        <div class='ac-descriptions__body'>
          <table
            class={[
              'ac-descriptions__table',
              { 'is-bordered': border },
              descriptionsSize ? `ac-descriptions--${descriptionsSize}` : '',
            ]}
          >
            {rows.map((row) => (
