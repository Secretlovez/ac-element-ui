...
<script>
import { hasClass } from '@syhr/ac-element-ui/src/utils/dom';
import { isObject } from '@syhr/ac-element-ui/src/utils/types';
...
export default {
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default() {
        return ['ac-icon-star-on', 'ac-icon-star-on', 'ac-icon-star-on'];
      },
    },
    voidIconClass: {
      type: String,
      default: 'ac-icon-star-off',
    },
    disabledVoidIconClass: {
      type: String,
      default: 'ac-icon-star-on',
    },
    disabled: {
      type: Boolean,
      default: false,
  ...
  methods: {
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, 'ac-rate__item')) {
          target = target.querySelector('.ac-rate__icon');
        }
        if (hasClass(target, 'ac-rate__decimal')) {
