<template>
  <div
    class="ac-select"
    :class="[selectSize ? 'ac-select--' + selectSize : '']"
    @click.stop="toggleMenu"
    v-clickoutside="handleClose"
  >
    <div
      class="ac-select__tags"
      v-if="multiple"
      ref="tags"
    ...
    >
      <span v-if="collapseTags && selected.length">
        <el-tag
          ...
          disable-transitions
        >
          <span class="ac-select__tags-text">{{
        ...
        <el-tag
          ...
          disable-transitions
        >
          <span class="ac-select__tags-text">+ {{ selected.length - 1 }}</span>
        </el-tag>
      </span>
      <transition-group @after-leave="resetInputHeight" v-if="!collapseTags">
        <el-tag
          ...
          disable-transitions
        >
          <span class="ac-select__tags-text">{{ item.currentLabel }}</span>
        </el-tag>
      </transition-group>

      <input
        type="text"
        class="ac-select__input"
    ...
    >
      ...
      <template slot="suffix">
        ...
        <i
          v-if="showClose"
          class="ac-select__caret ac-input__icon ac-icon-circle-close"
    ...
    >
      ...
      >
        ...
        >
          ...
          <p class="ac-select-dropdown__empty" v-else>
            {{ emptyText }}
          </p>
        </template>
      </el-select-menu>
...
import Focus from '@syhr/ac-element-ui/src/mixins/focus';
...
import scrollIntoView from '@syhr/ac-element-ui/src/utils/scroll-into-view';
import {
  getValueByPath,
  valueEquals,
  isIE,
...
import { isKorean } from '@syhr/ac-element-ui/src/utils/shared';
