...
import ElRadio from '@syhr/ac-element-ui/packages/radio';
import { isEqual } from '@syhr/ac-element-ui/src/utils/util';
...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return <i class='ac-icon-check ac-cascader-node__prefix' />;
    },

    renderLoadingIcon(h) {
      return <i class='ac-icon-loading ac-cascader-node__postfix' />;
    },

    renderExpandIcon(h) {
      return <i class='ac-icon-arrow-right ac-cascader-node__postfix' />;
    },
    ...
    renderContent(h) {
      ...
      return <span class='ac-cascader-node__label'>{vnode || node.label}</span>;
    },
  },
