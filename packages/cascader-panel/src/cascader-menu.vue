...
export default {
  ...
  methods: {
    ...
    renderEmptyText(h) {
      return (
        <div class='ac-cascader-menu__empty-text'>
    ...
    renderNodeList(h) {
      ...
      return [
        ...nodes,
        isHoverMenu ? (
          <svg ref='hoverZone' class='ac-cascader-menu__hover-zone' />
        ) : null,
      ];
    },
  },
  ...
  render(h) {
    ...
    return (
      <el-scrollbar
        ...
        role='menu'
        id={menuId}
        class='ac-cascader-menu'
        wrap-class='ac-cascader-menu__wrap'
        view-class={{
          'ac-cascader-menu__list': true,
          'is-empty': isEmpty,
        }}
        {...events}
      >
