<template>
  <div
    :class="['ac-cascader-panel', border && 'is-bordered']"
  ...
  methods: {
        ...
        case KeyCode.left:
          ...
          if (preMenu) {
            const expandedNode = preMenu.$el.querySelector(
              '.ac-cascader-node[aria-expanded="true"]'
            );
    ...
    scrollIntoView() {
      ...
      menus.forEach((menu) => {
        ...
        if (menuElement) {
          const container = menuElement.querySelector('.ac-scrollbar__wrap');
          const activeNode =
            menuElement.querySelector('.ac-cascader-node.is-active') ||
            menuElement.querySelector('.ac-cascader-node.in-active-path');
