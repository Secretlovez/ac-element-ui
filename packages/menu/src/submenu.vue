...
export default {
  ...
  computed: {
    ...
    menuTransitionName() {
      return this.rootMenu.collapse ? 'ac-zoom-in-left' : 'ac-zoom-in-top';
    },
    opened() {
  ...
  render(h) {
    ...
    const popupMenu = (
      <transition name={menuTransitionName}>
        <div
          ref='menu'
          v-show={opened}
          class={[`ac-menu--${mode}`, popperClass]}
        ...
        >
          <ul
            role='menu'
            class={[
              'ac-menu ac-menu--popup',
              `ac-menu--popup-${currentPlacement}`,
            ]}
    ...
    return (
      ...
      >
        ...
        >
          {$slots.title}
          <i class={['ac-submenu__icon-arrow', submenuTitleIcon]} />
        </div>
