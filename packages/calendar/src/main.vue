<template>
  <div class="ac-calendar">
    <div class="ac-calendar__header">
      <div class="ac-calendar__title">
        {{ i18nDate }}
      </div>
      <div class="ac-calendar__button-group" v-if="validatedRange.length === 0">
        <el-button-group>
    ...
    <div v-else class="ac-calendar__body" key="has-range">
      <date-table
...
import fecha from '@syhr/ac-element-ui/src/utils/date';
...
import { validateRangeInOneMonth } from '@syhr/ac-element-ui/src/utils/date-util';
