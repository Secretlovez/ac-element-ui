...
class TableLayout {
  ...
  updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      const body = bodyWrapper.querySelector('.ac-table__body');
  ...
  updateElsHeight() {
    ...
    const headerTrElm = headerWrapper
      ? headerWrapper.querySelector('.ac-table__header tr')
      : null;
  ...
  syncFixedTableRowHeight() {
    ...
    const bodyRows = bodyWrapper.querySelectorAll('.ac-table__row') || [];
