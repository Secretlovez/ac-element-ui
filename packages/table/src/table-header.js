...
export default {
        ...
        <thead class={[{ 'is-group': isGroup, 'has-gutter': this.hasGutter }]}>
          {this._l(columnRows, (columns, rowIndex) => (
            ...
            >
              {columns.map((column, cellIndex) => (
                ...
                >
                  ...
                  >
                    ...
                    {column.filterable ? (
                      <span
                        class='ac-table__column-filter-trigger'
                        on-click={($event) =>
                      ...
                      >
                        <i
                          class={[
                            'ac-icon-arrow-down',
                            column.filterOpened ? 'ac-icon-arrow-up' : '',
                          ]}
                        />
                      </span>
                    ) : (
              ...
              {this.hasGutter ? <th class='ac-table__cell gutter' /> : ''}
            </tr>
          ))}
        </thead>
      </table>
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.ac-table__column-filter-trigger') || cell;
