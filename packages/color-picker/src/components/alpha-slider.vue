<template>
  <div class="ac-color-alpha-slider" :class="{ 'is-vertical': vertical }">
    <div
      class="ac-color-alpha-slider__bar"
      @click="handleClick"
      ref="bar"
      :style="{
    ...
    ></div>
    <div
      class="ac-color-alpha-slider__thumb"
      ref="thumb"
      :style="{
        left: thumbLeft + 'px',
        top: thumbTop + 'px',
