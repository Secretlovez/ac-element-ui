<template>
  <div
    class="ac-slider"
    :class="{ 'is-vertical': vertical, 'ac-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="ac-slider__runway"
      :class="{ 'show-input': showInput, disabled: sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider"
    >
      <div class="ac-slider__bar" :style="barStyle"></div>
      <slider-button
        :vertical="vertical"
        v-model="firstValue"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="ac-slider__stop ac-slider__marks-stop"
            :key="key"
          ></div>
        </div>
        <div class="ac-slider__marks">
          <slider-marker
            :mark="item.mark"
            v-for="(item, key) in markList"
            :key="key"
...
import ElInputNumber from '@syhr/ac-element-ui/packages/input-number';
