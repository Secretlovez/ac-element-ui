...
import ElSelect from '@syhr/ac-element-ui/packages/select';
import ElOption from '@syhr/ac-element-ui/packages/option';
import ElInput from '@syhr/ac-element-ui/packages/input';
import Locale from '@syhr/ac-element-ui/src/mixins/locale';
import { valueEquals } from '@syhr/ac-element-ui/src/utils/util';
...
export default {
  ...
  render(h) {
      ...
      <div
        class={[
          'ac-pagination',
          {
            ...
            'ac-pagination--small': this.small,
          },
        ]}
      />
    );
    ...
    const rightWrapper = <div class='ac-pagination__rightwrapper' />;
  ...
  components: {
        ...
        return (
          ...
          >
            {this.$parent.prevText ? (
              ...
              <i class='ac-icon ac-icon-arrow-left' />
            )}
          </button>
        );
      },
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class='ac-pagination__sizes'>
            <el-select
    ...
    Total: {
      ...
      render(h) {
        return typeof this.$parent.total === 'number' ? (
          <span class='ac-pagination__total'>
