<template>
  ...
  >
    <div
      ...
      :class="popperClass"
      class="ac-picker-panel time-select ac-popper"
    >
      <el-scrollbar noresize wrap-class="ac-picker-panel__content">
        <div
...
export default {
  ...
  methods: {
    ...
    scrollToOption(selector = '.selected') {
      const menu = this.$refs.popper.querySelector('.ac-picker-panel__content');
