<template>
  <transition name="ac-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="ac-time-range-picker ac-picker-panel ac-popper"
      :class="popperClass"
    >
      <div class="ac-time-range-picker__content">
        <div class="ac-time-range-picker__cell">
          <div class="ac-time-range-picker__header">
            {{ t('el.datepicker.startTime') }}
          </div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ac-time-range-picker__body ac-time-panel__content"
          >
            <time-spinner
              ref="minSpinner"
      ...
      <div class="ac-time-panel__footer">
        <button
          type="button"
          class="ac-time-panel__btn cancel"
          @click="handleCancel()"
        >
        ...
        <button
          type="button"
          class="ac-time-panel__btn confirm"
          @click="handleConfirm()"
