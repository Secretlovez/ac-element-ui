<template>
  <transition name="ac-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="ac-picker-panel ac-date-range-picker ac-popper"
      :class="[
        {
    ...
    >
      <div class="ac-picker-panel__body-wrapper">
        <slot name="sidebar" class="ac-picker-panel__sidebar"></slot>
        <div class="ac-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="ac-picker-panel__shortcut"
        ...
        <div class="ac-picker-panel__body">
          <div class="ac-date-range-picker__time-header" v-if="showTime">
            <span class="ac-date-range-picker__editors-wrap">
              <span class="ac-date-range-picker__time-picker-wrap">
                <el-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="ac-date-range-picker__editor"
              ...
              <span
                class="ac-date-range-picker__time-picker-wrap"
            ...
            <span class="ac-date-range-picker__editors-wrap is-right">
              <span class="ac-date-range-picker__time-picker-wrap">
                <el-input
                  size="small"
                  class="ac-date-range-picker__editor"
          ...
          <div
            class="ac-picker-panel__content ac-date-range-picker__content is-left"
          >
            <div class="ac-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="ac-picker-panel__icon-btn ac-icon-d-arrow-left"
              ></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="ac-picker-panel__icon-btn ac-icon-arrow-left"
              ></button>
              <button
                type="button"
                @click="leftNextYear"
                ...
                class="ac-picker-panel__icon-btn ac-icon-d-arrow-right"
              ></button>
              <button
                type="button"
                @click="leftNextMonth"
                ...
                class="ac-picker-panel__icon-btn ac-icon-arrow-right"
              ></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div
            class="ac-picker-panel__content ac-date-range-picker__content is-right"
          >
            <div class="ac-date-range-picker__header">
              <button
                type="button"
      ...
      <div class="ac-picker-panel__footer" v-if="showTime">
        <el-button
          size="mini"
          type="text"
          class="ac-picker-panel__link-btn"
          @click="handleClear"
        >
...
import {
  ...
  extractDateFormat,
  extractTimeFormat,
} from '@syhr/ac-element-ui/src/utils/date-util';
