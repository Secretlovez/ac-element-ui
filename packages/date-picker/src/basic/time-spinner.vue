<template>
  <div class="ac-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <el-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="ac-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="ac-time-spinner__list"
        noresize
        tag="ul"
        ref="hours"
      >
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="ac-time-spinner__wrapper is-arrow"
      >
        <i
          v-repeat-click="decrease"
          class="ac-time-spinner__arrow ac-icon-arrow-up"
        ></i>
        <i
          v-repeat-click="increase"
          class="ac-time-spinner__arrow ac-icon-arrow-down"
        ></i>
        <ul class="ac-time-spinner__list" ref="hours">
          <li
            class="ac-time-spinner__item"
      ...
      >
        ...
        <i
          ...
          class="ac-time-spinner__arrow ac-icon-arrow-down"
        ></i>
        <ul class="ac-time-spinner__list" ref="minutes">
          <li
            class="ac-time-spinner__item"
      ...
      >
        ...
        <i
          ...
          class="ac-time-spinner__arrow ac-icon-arrow-down"
        ></i>
        <ul class="ac-time-spinner__list" ref="seconds">
          <li
...
import RepeatClick from '@syhr/ac-element-ui/src/directives/repeat-click';
