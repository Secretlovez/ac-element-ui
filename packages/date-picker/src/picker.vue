<template>
  <el-input
    class="ac-date-editor"
    :class="'ac-date-editor--' + type"
  ...
  <div
    class="ac-date-editor ac-range-editor ac-input__inner"
    :class="[
      'ac-date-editor--' + type,
      pickerSize ? `ac-range-editor--${pickerSize}` : '',
    ...
    v-else
  >
    <i :class="['ac-input__icon', 'ac-range__icon', triggerClass]"></i>
    <input
      autocomplete="off"
      ...
      @focus="handleFocus"
      class="ac-range-input"
    />
    <slot name="range-separator">
      <span class="ac-range-separator">{{ rangeSeparator }}</span>
    </slot>
    <input
      autocomplete="off"
    ...
    <i
      ...
      v-if="haveTrigger"
      :class="[showClose ? '' + clearIcon : '']"
      class="ac-input__icon ac-range__close-icon"
    >
    </i>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    triggerClass() {
      return (
        this.prefixIcon ||
        (this.type.indexOf('time') !== -1 ? 'ac-icon-time' : 'ac-icon-date')
      );
    },
