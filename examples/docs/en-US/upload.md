...
>
  ...
  <i v-else class="ac-icon-plus avatar-uploader-icon"></i>
</el-upload>

<style>
  .avatar-uploader .ac-upload {
  ...
  .avatar-uploader .ac-upload:hover {
    border-color: #409eff;
  }
...
<el-upload action="#" list-type="picture-card" :auto-upload="false">
  <i slot="default" class="ac-icon-plus"></i>
