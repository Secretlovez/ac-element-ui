...
<template>
  <div class="component-preview">
    ...
    <el-row>
      <div
        role="alert"
        class="demo-item ac-message ac-message--success ac-message-fade-leave-active ac-message-fade-leave-to"
        style="
          top: 0;
          left: 0;
          width: 100px;
        ...
        "
      >
        <i class="ac-message__icon ac-icon-success"></i>
        <p class="ac-message__content">Congrats, this is a success message.</p>
        <!---->
      </div>
      <div
        role="alert"
        class="demo-item ac-message ac-message--warning ac-message-fade-leave-active ac-message-fade-leave-to"
        style="
          top: 0;
          left: 0;
          width: 100px;
        ...
        "
      >
        <i class="ac-message__icon ac-icon-warning"></i>
        <p class="ac-message__content">Warning, this is a warning message.</p>
        <!---->
      </div>
      <div
        role="alert"
        class="demo-item ac-message ac-message--info ac-message-fade-leave-active ac-message-fade-leave-to"
        style="
          top: 0;
          left: 0;
          width: 100px;
        ...
        "
      >
        <i class="ac-message__icon ac-icon-info"></i>
        <p class="ac-message__content">This is a message.</p>
        <!---->
      </div>
      <div
        role="alert"
        class="demo-item ac-message ac-message--error is-closable ac-message-fade-leave-active ac-message-fade-leave-to"
        style="
          top: 0;
          left: 0;
          width: 100px;
        ...
        "
      >
        <i class="ac-message__icon ac-icon-error"></i>
        <p class="ac-message__content">Oops, this is a error message.</p>
        <i class="ac-message__closeBtn ac-icon-close"></i>
      </div>
    </el-row>
    <h4>MessageBox</h4>
    <el-row>
      <div class="ac-message-box">
        <div class="ac-message-box__header">
          <div class="ac-message-box__title"><!----><span>Warning</span></div>
          <button
            type="button"
            aria-label="Close"
        ...
        <div class="ac-message-box__content">
          <div class="ac-message-box__status ac-icon-warning"></div>
          <div class="ac-message-box__message">
            <p>This will permanently delete the file. Continue?</p>
          </div>
          <div class="ac-message-box__input" style="display: none">
            <div class="ac-input">
              <!----><input
                type="text"
                autocomplete="off"
            ...
            <div
              class="ac-message-box__errormsg"
        ...
        <div class="ac-message-box__btns">
          <button
            type="button"
            class="ac-button ac-button--default ac-button--small"
          >
            <!----><!----><span> Cancel </span></button
          ><button
            type="button"
            class="ac-button ac-button--default ac-button--small ac-button--primary"
          >
            <!----><!----><span> OK </span>
          </button>
        </div>
    ...
    <el-row>
      <div
        role="alert"
        class="ac-notification right"
        style="position: relative; left: 0"
      >
        <!---->
        <div class="ac-notification__group">
          <span class="ac-notification__title">Notification</span>
          <div class="ac-notification__content">
            <div>This is a message</div>
          </div>
          <div class="ac-notification__closeBtn ac-icon-close"></div>
        </div>
      </div>
    </el-row>
    <h4>Menu</h4>
    <el-row>
      <el-menu :default-active="menu" class="ac-menu-demo" mode="horizontal">
    ...
    <el-row>
      ...
      >
        <div class="ac-dialog__header">
          <span class="ac-dialog__title">Tips</span
          ><button
            type="button"
            aria-label="Close"
        ...
        <div class="ac-dialog__body"><span>This is a message</span></div>
        <div class="ac-dialog__footer">
          <span class="dialog-footer"
            ><button type="button" class="ac-button ac-button--default">
              <!----><!----><span>Cancel</span>
            </button>
            <button type="button" class="ac-button ac-button--primary">
              <!----><!----><span>Confirm</span>
            </button></span
          >
        </div>
    ...
    <el-row>
      <div
        role="tooltip"
        x-placement="top"
        class="ac-tooltip__popper is-dark"
      ...
      <div
        role="tooltip"
        x-placement="top"
        class="ac-tooltip__popper is-light"
        style="
          margin-top: 10px;
          position: relative;
          width: 40px;
    ...
    <el-row>
      <div
        ...
        id="ac-popover-2936"
        aria-hidden="true"
        class="ac-popover ac-popper ac-popover--plain"
        tabindex="0"
        style="width: 200px; position: relative"
      >
        <div class="ac-popover__title">Title</div>
    ...
    <el-row>
      <el-carousel height="150px">
        <el-carousac-item v-for="item in 4" :key="item">
          <h3>{{ item }}</h3>
        </el-carousac-item>
      </el-carousel>
    </el-row>
    ...
    <el-row class="demo-line avatar-demo">
      <el-avatar icon="ac-icon-user-solid" />
