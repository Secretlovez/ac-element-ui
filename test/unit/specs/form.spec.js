...
describe('Form', () => {
  ...
  it('label width', (done) => {
    ...
    expect(vm.$el.querySelector('.ac-form-item__label').style.width).to.equal(
      '80px'
    );
    expect(
      vm.$el.querySelector('.ac-form-item__content').style.marginLeft
    ).to.equal('80px');
    done();
  });
  it('auto label width', async () => {
    ...
    const formItems = vm.$el.querySelectorAll('.ac-form-item__content');
    ...
    const formItem = vm.$el.querySelector('.ac-form-item__content');
  ...
  it('inline form', (done) => {
    ...
    expect(vm.$el.classList.contains('ac-form--inline')).to.be.true;
    done();
  });
  ...
  it('show message', (done) => {
    ...
    vm.$refs.form.validate((valid) => {
      ...
      vm.$refs.form.$nextTick((_) => {
        expect(vm.$el.querySelector('.ac-form-item__error')).to.not.exist;
        done();
      });
    });
  });
