...
describe('Badge', () => {
  ...
  it('is fixed', () => {
    ...
    expect(vm.$el.querySelector('.ac-badge__content.is-fixed')).to.exist;
  });
  ...
  it('is dot', () => {
    ...
    expect(vm.$el.querySelector('.ac-badge__content.is-dot')).to.exist;
  });
  ...
  it('is dot with type', () => {
    ...
    expect(
      vm.$el.querySelector(
        '.ac-badge__content.ac-badge__content--success.is-dot'
      )
    ).to.exist;
  });
