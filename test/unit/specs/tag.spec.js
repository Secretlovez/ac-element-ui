...
describe('Tag', () => {
  ...
  it('create', () => {
    ...
    expect(vm.$el.classList.contains('ac-tag')).to.be.true;
    expect(vm.$el.classList.contains('ac-tag__close')).to.be.false;
  ...
  it('type', () => {
    ...
    expect(vm.$el.classList.contains('ac-tag--primary')).to.be.true;
  });
  ...
  it('closable', (done) => {
    ...
    var closeBtn = vm.$el.querySelector('.ac-tag .ac-tag__close');
  ...
  it('theme', () => {
    ...
    const el = vm.$el;
    expect(el.className).to.includes('ac-tag--dark');
    expect(el.className).to.not.includes('ac-tag--light');
    expect(el.className).to.not.includes('ac-tag--plain');
  });
});
