...
describe('Button', () => {
  ...
  it('create', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('ac-button--primary')).to.be.true;
  });
  it('icon', () => {
    vm = createTest(
      Button,
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.querySelector('.ac-icon-search')).to.be.ok;
  });
  it('nativeType', () => {
    vm = createTest(
      Button,
  ...
  it('loading', () => {
    ...
    expect(buttonElm.querySelector('.ac-icon-loading')).to.be.ok;
  });
  it('disabled', () => {
    vm = createTest(
      Button,
  ...
  it('size', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('ac-button--medium')).to.be.true;
  });
  it('plain', () => {
    vm = createTest(
      Button,
