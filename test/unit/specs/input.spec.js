...
describe('Input', () => {
  ...
  it('suffixIcon', () => {
    ...
    var icon = vm.$el.querySelector('.ac-input__icon');
  ...
  it('size', () => {
    ...
    expect(vm.$el.classList.contains('ac-input--large')).to.true;
  });
  ...
  it('type', () => {
    ...
    expect(vm.$el.classList.contains('ac-textarea')).to.true;
  });
  ...
  it('rows', () => {
    ...
    expect(
      vm.$el.querySelector('.ac-textarea__inner').getAttribute('rows')
    ).to.be.equal('3');
  });
  ...
  it('resize', async () => {
    ...
    await waitImmediate();
    expect(
      vm.$el.querySelector('.ac-textarea__inner').style.resize
  ...
  it('Input contains Select and append slot', async () => {
    ...
    const suffixEl = document.querySelector(
      '.input-with-select > .ac-input__suffix'
    );
  ...
  describe('Input Events', () => {
    ...
    it('event:clear', async () => {
      ...
      await waitImmediate();
      vm.$el.querySelector('.ac-input__clear').click();
      await waitImmediate();
  ...
  it('limit input and show word count', async () => {
    ...
    expect(inputElm1.querySelectorAll('.ac-input__count').length).to.equal(0);
    expect(inputElm2.querySelectorAll('.ac-input__count').length).to.equal(1);
    expect(inputElm3.querySelectorAll('.ac-input__count').length).to.equal(0);
    expect(inputElm4.classList.contains('is-exceed')).to.true;

    vm.show = true;
    await waitImmediate();
    expect(inputElm1.querySelectorAll('.ac-input__count').length).to.equal(1);
