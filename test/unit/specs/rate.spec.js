...
describe('Rate', () => {
  ...
  it('create', () => {
    ...
    const stars = vm.$el.querySelectorAll('.ac-rate__item');
  ...
  it('with texts', () => {
    ...
    const text = vm.$el.querySelector('.ac-rate__text');
  ...
  it('click', () => {
    ...
    const thirdStar = vm.$el.querySelectorAll('.ac-rate__item')[2];
    thirdStar.click();
  ...
  it('colors', () => {
    ...
    const thirdIcon = vm.$el
      .querySelectorAll('.ac-rate__item')[2]
      .querySelector('.ac-rate__icon');
  ...
  it('disabled', () => {
    ...
    const firstStar = vm1.$el.querySelectorAll('.ac-rate__item')[0];
    firstStar.click();
    vm1.$children[0].resetCurrentValue();
    expect(vm1.value).to.equal(3.7);

    const fourthStar = vm2.$el.querySelectorAll('.ac-rate__item')[3];
    const halfStar = fourthStar.querySelector('.ac-rate__decimal');
  ...
  it('allow half', () => {
    ...
    const rate = vm.$children[0];
    const secondStar = vm.$el.querySelectorAll('.ac-rate__item')[1];
  ...
  it('custom icon classes by passing object', () => {
    ...
    const thirdIcon = vm.$el
      .querySelectorAll('.ac-rate__item')[3]
      .querySelector('.ac-rate__icon');
