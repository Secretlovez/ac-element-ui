...
describe('Drawer', () => {
  ...
  it('create', async () => {
    ...
    expect(vm.$el.querySelector('.ac-drawer__header').textContent).to.equal(
      title
    );
  ...
  it('render correct content', async () => {
    ...
    await waitImmediate();
    expect(vm.$el.querySelector('.ac-drawer__body span').textContent).to.equal(
      '这是一段信息'
    );
    const footerBtns = vm.$el.querySelectorAll('.ac-button');
  ...
  it('should destroy every child after drawer was closed when destroy-on-close flag is true', async () => {
    ...
    await wait(400);
    expect(vm.$el.querySelector('.ac-drawer__body')).not.to.exist;
  });
  ...
  it('should close dialog by clicking the close button', async () => {
    ...
    await waitImmediate();
    vm.$children[0].$el.querySelector('.ac-drawer__close-btn').click();
  ...
  it('should not show close button when show-close flag is false', async () => {
    ...
    expect(vm.$el.querySelector('.ac-drawer__close-btn')).not.to.exist;
  });
  ...
  it('should not render header when withHeader attribute is false', () => {
    ...
    expect(vm.$el.querySelector('.ac-drawer__header')).to.not.exist;
  });
  ...
  describe('size', () => {
    ...
    it('should effect height when drawer is vertical', async () => {
      ...
      expect(vm.$el.querySelector('.ac-drawer').style.width).to.equal('50%');
    });

    it('should effect width when drawer is horizontal', async () => {
      const size = '50%';
      vm = renderer(size, false);
      expect(vm.$el.querySelector('.ac-drawer').style.height).to.equal('50%');
    });
  });
});
