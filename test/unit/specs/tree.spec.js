...
describe('Tree', () => {
  ...
  it('create', () => {
    ...
    expect(document.querySelector('.ac-tree')).to.exist;
    expect(
      document.querySelectorAll('.ac-tree > .ac-tree-node').length
    ).to.equal(3);
    expect(document.querySelectorAll('.ac-tree .ac-tree-node').length).to.equal(
      ALL_NODE_COUNT
    );
  ...
  it('click node', (done) => {
    ...
    const firstNode = vm.$el.querySelector('.ac-tree-node__content');
    firstNode.click();
    expect(vm.clickedNode.label).to.equal('一级 1');
    setTimeout(() => {
      expect(
        vm.$el.querySelector('.ac-tree-node').classList.contains('is-expanded')
      ).to.true;
      firstNode.click();
      setTimeout(() => {
        expect(
          vm.$el
            .querySelector('.ac-tree-node')
  ...
  it('emptyText', (done) => {
    ...
    vm.data = [];
    vm.$nextTick(() => {
      expect(vm.$el.querySelectorAll('.ac-tree__empty-block').length).to.equal(
        1
      );
      done();
    });
  ...
  it('highlight current', (done) => {
    ...
    const firstNode = document.querySelector('.ac-tree-node');
    firstNode.click();
    vm.$nextTick(() => {
  ...
  it('current-node-key', () => {
    ...
    const currentNodeLabel = document.querySelector(
      '.is-current .ac-tree-node__label'
    ).textContent;
  ...
  it('defaultExpandAll', () => {
    vm = getTreeVm(':props="defaultProps" default-expand-all');
    expect(
      vm.$el.querySelectorAll('.ac-tree-node.is-expanded').length
  ...
  it('filter-node-method', (done) => {
    ...
    setTimeout(() => {
      expect(
        tree.$el.querySelectorAll('.ac-tree-node.is-hidden').length
      ).to.equal(3);
      done();
    }, 100);
  });
  ...
  it('autoExpandParent = false', (done) => {
    ...
    const firstNode = document.querySelector('.ac-tree-node__content');
    firstNode.querySelector('.ac-tree-node__expand-icon').click();
    setTimeout(() => {
      expect(
        document.querySelectorAll('.ac-tree-node.is-expanded').length
      ).to.equal(2);
      done();
    }, 100);
  });
  ...
  it('defaultCheckedKeys & check-strictly = false', () => {
    ...
    expect(vm.$el.querySelectorAll('.ac-checkbox .is-checked').length).to.equal(
      3
    );
  });
  ...
  it('show checkbox', (done) => {
    ...
    const tree = vm.$children[0];
    const secondNode = document.querySelectorAll('.ac-tree-node__content')[1];
    const nodeCheckbox = secondNode.querySelector('.ac-checkbox');
    ...
    setTimeout(() => {
      ...
      secondNode.querySelector('.ac-tree-node__expand-icon').click();
      setTimeout(() => {
        const firstLeaf = secondNode.nextElementSibling.querySelector(
          '.ac-tree-node__content'
        );
        const leafCheckbox = firstLeaf.querySelector('.ac-checkbox');
        leafCheckbox.click();
        setTimeout(() => {
  ...
  it('set disabled checkbox', (done) => {
    ...
    const node = document.querySelectorAll('.ac-tree-node__content')[2];
    const nodeCheckbox = node.querySelector('.ac-checkbox input');
    vm.$nextTick(() => {
  ...
  it('check strictly', (done) => {
    ...
    const tree = vm.$children[0];
    const secondNode = document.querySelectorAll('.ac-tree-node__content')[3];
    const nodeCheckbox = secondNode.querySelector('.ac-checkbox');
    nodeCheckbox.click();
    expect(tree.getCheckedNodes().length).to.equal(1);
  ...
  it('render content', () => {
    ...
    const button = firstNode.querySelector('.custom-content .ac-button');
  ...
  it('scoped slot', () => {
    ...
    const button = firstNode.querySelector('.ac-button');
  ...
  it('load node', (done) => {
    ...
    const nodes = document.querySelectorAll('.ac-tree-node__content');
    expect(nodes.length).to.equal(2);
    nodes[0].click();
    setTimeout(() => {
      expect(
        document.querySelectorAll('.ac-tree-node__content').length
      ).to.equal(4);
      done();
    }, 100);
  });
  ...
  it('lazy defaultChecked', (done) => {
    ...
    setTimeout(() => {
      ...
      const child = document.querySelectorAll('.ac-tree-node__content')[1];
  ...
  it('accordion', (done) => {
    ...
    const secondNode = vm.$el.querySelector(
      '.ac-tree-node:nth-child(2) .ac-tree-node__content'
    );
    firstNode.click();
    setTimeout(() => {
      expect(
  ...
  it('updateKeyChildren', (done) => {
    ...
    const node = document.querySelectorAll('.ac-tree-node__content')[2];
    const label = node.querySelector('.ac-tree-node__label');
    vm.$nextTick(() => {
