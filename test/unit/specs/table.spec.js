...
describe('Table', () => {
  describe('rendering data is correct', () => {
    ...
    it('row length', () => {
      expect(
        vm.$el.querySelectorAll('.ac-table__body-wrapper tbody tr')
  ...
  describe('attributes', () => {
    ...
    it('stripe', (done) => {
      ...
      setTimeout((_) => {
        expect(vm.$el.classList.contains('ac-table--striped')).to.true;
        destroyVM(vm);
        done();
      }, DELAY);
    });
    ...
    it('border', (done) => {
      ...
      setTimeout((_) => {
        expect(vm.$el.classList.contains('ac-table--border')).to.true;
        destroyVM(vm);
        done();
      }, DELAY);
    });
    ...
    it('fit', (done) => {
      ...
      setTimeout((_) => {
        expect(vm.$el.classList.contains('ac-table--fit')).to.false;
        destroyVM(vm);
        done();
      }, DELAY);
    });
    ...
    it('show-header', (done) => {
      ...
      setTimeout((_) => {
        expect(
          vm.$el.querySelectorAll('.ac-table__header-wrapper').length
        ).to.equal(0);
        destroyVM(vm);
        done();
      }, DELAY);
    ...
    it('tableRowStyle[Object]', (done) => {
      ...
      setTimeout((_) => {
        expect(
          vm.$el.querySelector('.ac-table__body tr').style.height
        ).to.equal('60px');
        destroyVM(vm);
        done();
      }, DELAY);
    ...
    it('tableRowStyle[Function]', (done) => {
      ...
      setTimeout((_) => {
        let child1 = vm.$el.querySelector('.ac-table__body tr:nth-child(1)');
        let child2 = vm.$el.querySelector('.ac-table__body tr:nth-child(2)');
    ...
    it('current-row-key', (done) => {
      ...
      setTimeout((_) => {
        vm.currentRowKey = 1;
        const tr = vm.$el.querySelector('.ac-table__body-wrapper tbody tr');
        setTimeout((_) => {
          expect(tr.classList.contains('current-row')).to.be.true;
          vm.currentRowKey = 2;

          const rows = vm.$el.querySelectorAll(
            '.ac-table__body-wrapper tbody tr'
          );
          setTimeout((_) => {
    ...
    it('select-on-indeterminate', (done) => {
      ...
      setTimeout((_) => {
        vm.$el.querySelector('.ac-checkbox').click();
        setTimeout((_) => {
  ...
  describe('filter', () => {
    ...
    it('render', () => {
      expect(vm.$el.querySelector('.ac-table__column-filter-trigger')).to.exist;
    });

    it('click dropdown', (done) => {
      const btn = vm.$el.querySelector('.ac-table__column-filter-trigger');
      triggerEvent(btn, 'click', true, false);
      setTimeout((_) => {
        const filter = document.body.querySelector('.ac-table-filter');
    ...
    it('click filter', (done) => {
      ...
      setTimeout((_) => {
        ...
        // John Lasseter
        triggerEvent(
          filter.querySelector('.ac-checkbox'),
          'click',
          true,
          false
        );
        ...
        setTimeout((_) => {
          triggerEvent(
            filter.querySelector('.ac-table-filter__bottom button'),
            'click',
            true,
            false
          );
    ...
    it('click reset', (done) => {
      ...
      setTimeout((_) => {
        ...
        setTimeout((_) => {
          // reset button
          triggerEvent(
            filter.querySelectorAll('.ac-table-filter__bottom button')[1],
            'click',
            true,
            false
          );
          setTimeout((_) => {
            ...
            expect(
              filter
                .querySelector('.ac-table-filter__bottom button')
  ...
  describe('events', () => {
    ...
    it('select', (done) => {
      ...
      setTimeout((_) => {
        vm.$el.querySelectorAll('.ac-checkbox')[1].click();
    ...
    it('cell-mouse-enter', (done) => {
      ...
      setTimeout((_) => {
        const cell = vm.$el.querySelectorAll('.ac-table__body .cell')[2]; // first row
    ...
    it('cell-mouse-leave', (done) => {
      ...
      setTimeout((_) => {
        const cell = vm.$el.querySelectorAll('.ac-table__body .cell')[7]; // second row
        const cell2 = vm.$el.querySelectorAll('.ac-table__body .cell')[2]; // first row
    ...
    it('header-click', (done) => {
      ...
      setTimeout((_) => {
        const cell = vm.$el.querySelectorAll('.ac-table__header th')[1]; // header[prop='name']
  ...
  describe('column attributes', () => {
    ...
    it('width', (done) => {
      ...
      setTimeout((_) => {
        const ths = toArray(
          vm.$el.querySelectorAll('.ac-table__header-wrapper col')
        )
          .map((node) => node.width)
          .filter((o) => o);
    ...
    it('fixed', (done) => {
      ...
      setTimeout((_) => {
        expect(
          toArray(
            vm.$el.querySelectorAll('.ac-table__fixed th:not(.is-hidden)')
          ).map((node) => node.textContent)
        ).to.eql(['test1', 'test3']);

        expect(
          toArray(
            vm.$el.querySelectorAll('.ac-table__fixed-right th:not(.is-hidden)')
          ).map((node) => node.textContent)
        ).to.eql(['test2']);
        expect(
          vm.$el.querySelector('.ac-table__body-wrapper').style.height
        ).to.equal('');
        destroyVM(vm);
        done();
      }, DELAY);
      ...
      setTimeout((_) => {
        const cells = toArray(
          vm.$el.querySelectorAll(
            '.ac-table__body-wrapper tbody tr td:first-child'
          )
        );
    ...
    it('show-overflow-tooltip', (done) => {
      ...
      setTimeout((_) => {
        expect(vm.$el.querySelectorAll('.ac-tooltip')).to.length(5);
        destroyVM(vm);
        done();
      }, DELAY);
    });
    ...
    it('render-header', (done) => {
      ...
      setTimeout((_) => {
        const headerCell = vm.$el.querySelector(
          '.ac-table__header-wrapper thead tr th:first-child .cell'
        );
    ...
    it('selectable === false & check selectAll status', (done) => {
      ...
      setTimeout((_) => {
        expect(vm.$el.querySelector('.ac-checkbox').__vue__.checked).to.be
          .false;
        setTimeout((_) => {
          expect(vm.selected).to.length(0);
          destroyVM(vm);
    ...
    describe('type', () => {
      ...
      describe('= selection', () => {
        ...
        it('render', (done) => {
          setTimeout((_) => {
            expect(vm.$el.querySelectorAll('.ac-checkbox')).to.length(
        ...
        it('select one', (done) => {
          ...
          setTimeout((_) => {
            vm2.$el.querySelectorAll('.ac-checkbox')[1].click();
      ...
      describe('= expand', () => {
        ...
        it('works', (done) => {
          ...
          setTimeout((_) => {
            expect(
              vm.$el.querySelectorAll('td.ac-table__expand-column').length
            ).to.equal(5);
            destroyVM(vm);
            done();
          }, DELAY);
        ...
        it('should expand when click icon', (done) => {
          ...
          setTimeout((_) => {
            vm.$el
              .querySelector(
                'td.ac-table__expand-column .ac-table__expand-icon'
              )
              .click();
            setTimeout((_) => {
              expect(
                vm.$el.querySelectorAll('.ac-table__expanded-cell').length
              ).to.equal(1);
        ...
        setTimeout((_) => {
          ...
          setTimeout((_) => {
            const lastCells = vm.$el.querySelectorAll(
              '.ac-table__body-wrapper tbody tr td:last-child'
            );
  ...
  describe('summary row', () => {
    it('should render', (done) => {
      ...
      setTimeout((_) => {
        const footer = vm.$el.querySelector('.ac-table__footer');
    ...
    it('custom sum text', (done) => {
      ...
      setTimeout((_) => {
        const cells = toArray(
          vm.$el.querySelectorAll('.ac-table__footer .cell')
        );
  ...
  describe('multi level column', () => {
    it('should works', (done) => {
      ...
      setTimeout((_) => {
        const trs = vm.$el.querySelectorAll('.ac-table__header tr');
  ...
  describe('dynamic column attribtes', () => {
    ...
    it('label', (done) => {
      ...
      setTimeout(() => {
        expect(
          vm.$el.querySelector('.ac-table__header th .cell').textContent
        ).to.equal('name');
        vm.label = 'NAME';
        vm.$nextTick(() => {
          expect(
    ...
    it('align', (done) => {
      ...
      setTimeout(() => {
        expect(
          vm.$el.querySelectorAll('.ac-table__body td.is-right').length === 0
        ).to.be.true;
        vm.align = 'right';
        vm.$nextTick(() => {
          expect(
    ...
    it('header-align', (done) => {
      ...
      vm.$nextTick(() => {
        expect(
          vm.$el.querySelectorAll('.ac-table__header th.is-left').length
        ).to.above(0);
        expect(
          vm.$el.querySelectorAll('.ac-table__header th.is-center').length
        ).to.equal(0);
        expect(
          vm.$el.querySelectorAll('.ac-table__header th.is-right').length
        ).to.equal(0);
        vm.align = 'right';
        vm.$nextTick(() => {
          expect(
    ...
    it('width', (done) => {
      ...
      setTimeout(() => {
        expect(
          vm.$el.querySelector('.ac-table__body col').getAttribute('width')
        ).to.equal('100');
        vm.width = 200;
        setTimeout(() => {
          expect(
    ...
    it('fixed', (done) => {
      ...
      setTimeout(() => {
        expect(!vm.$el.querySelector('.ac-table__fixed')).to.be.true;
        vm.fixed = true;
        setTimeout(() => {
          expect(!!vm.$el.querySelector('.ac-table__fixed')).to.be.true;
          destroyVM(vm);
    ...
    it('prop', (done) => {
      ...
      setTimeout(() => {
        let firstColumnContent = vm.$el.querySelector(
          '.ac-table__body td .cell'
        ).textContent;
        let secondColumnContent = vm.$el.querySelector(
          '.ac-table__body td:nth-child(2) .cell'
        ).textContent;
        expect(firstColumnContent !== secondColumnContent).to.be.true;
        vm.prop = 'release';
        setTimeout(() => {
          firstColumnContent = vm.$el.querySelector('.ac-table__body td .cell')
            .textContent;
  ...
  describe('methods', () => {
    ...
    it('setCurrentRow', async () => {
      ...
      await waitImmediate();
      const secondRow = vm.$el.querySelectorAll('.ac-table__row')[1];
      ...
      setTimeout((_) => {
        ...
        setTimeout((_) => {
          ...
          const ths = vm.$el.querySelectorAll(
            '.ac-table__header-wrapper thead th'
          );
  ...
  it('keep highlight row when data change', (done) => {
    ...
    setTimeout(() => {
      let rows = vm.$el.querySelectorAll('.ac-table__body-wrapper tbody tr');
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          rows = vm.$el.querySelectorAll('.ac-table__body-wrapper tbody tr');
          expect(rows[3].classList.contains('current-row')).to.be.true;
          destroyVM(vm);
          done();
        }, DELAY);
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        const cells = vm.$el.querySelectorAll(
          '.ac-table__header-wrapper thead th > .cell'
        );
  ...
  it('table append is visible in viewport if height is 100%', async () => {
    ...
    await waitImmediate();
    const emptyBlockEl = vm.$el.querySelector('.ac-table__empty-block');
  ...
  describe('tree', () => {
    ...
    it('render tree structual data', async () => {
      ...
      vm.$el.querySelector('.ac-table__expand-icon').click();
    ...
    it('load substree row data', async () => {
      ...
      const expandIcon = vm.$el.querySelector('.ac-table__expand-icon');
      expandIcon.click();

      await waitImmediate();

      expect(expandIcon.classList.contains('ac-table__expand-icon--expanded'))
        .to.be.true;
      expect(vm.$el.querySelectorAll('.ac-table__row').length).to.equal(8);
    });
    ...
    it('expand-row-keys & toggleRowExpansion', async () => {
      ...
      const expandIcon = childRows[0].querySelector('.ac-table__expand-icon');
      expandIcon.click();
