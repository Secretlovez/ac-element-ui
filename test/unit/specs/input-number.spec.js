...
describe('InputNumber', () => {
  ...
  it('decrease', (done) => {
    ...
    let input = vm.$el.querySelector('input');
    let btnDecrease = vm.$el.querySelector('.ac-input-number__decrease');
  ...
  it('increase', (done) => {
    ...
    let input = vm.$el.querySelector('input');
    let btnIncrease = vm.$el.querySelector('.ac-input-number__increase');
  ...
  describe('precision', () => {
    ...
    it('precision greater than the precision of step', (done) => {
      ...
      const btnIncrease = vm.$el.querySelector('.ac-input-number__increase');
  ...
  it('controls', () => {
    ...
    expect(vm.$el.querySelector('.ac-input-number__decrease')).to.not.exist;
    expect(vm.$el.querySelector('.ac-input-number__increase')).to.not.exist;
  });
