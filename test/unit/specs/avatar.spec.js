...
describe('Avatar', () => {
  ...
  it('size is string', () => {
    ...
    const avatarElm = vm.$el;
    expect(avatarElm.classList.contains('ac-avatar--small')).to.be.true;
  });
  ...
  it('shape', () => {
    ...
    const avatarElm = vm.$el;
    expect(avatarElm.classList.contains('ac-avatar--square')).to.be.true;
  });
  ...
  it('icon avatar', () => {
    ...
    expect(avatarElm.classList.contains('ac-avatar--icon')).to.be.true;
    expect(iconELm.classList.contains('ac-icon-user-solid')).to.be.true;
  });
