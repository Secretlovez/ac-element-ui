...
describe('Checkbox', () => {
  ...
  it('create', (done) => {
    ...
    expect(checkboxElm.classList.contains('ac-checkbox')).to.be.true;
    checkboxElm.click();
    vm.$nextTick((_) => {
  ...
  describe('checkbox-button', () => {
    ...
    it('create', (done) => {
      ...
      let checkboxElm = vm.$el;
      expect(checkboxElm.classList.contains('ac-checkbox-button')).to.be.true;
      checkboxElm.click();
      vm.$nextTick((_) => {
    ...
    it('checkbox group props', () => {
      ...
      expect(vm.$refs.a.$el.classList.contains('ac-checkbox-button--large')).to
        .be.true;
      expect(
        vm.$refs.a.$el.querySelector('.ac-checkbox-button__inner').style
          .backgroundColor
      ...
      expect(
        vm.$refs.a.$el.querySelector('.ac-checkbox-button__inner').style.color
      ).to.be.eql('rgb(0, 0, 0)');
