...
describe('Steps', () => {
  ...
  it('create', () => {
    ...
    expect(vm.$el.querySelectorAll('.ac-step')).to.length(3);
  });
  ...
  it('space', async () => {
    ...
    await waitImmediate();
    const stepElm = vm.$el.querySelector('.ac-step');
    const stepElm2 = vm2.$el.querySelector('.ac-step');
  ...
  it('processStatus', (done) => {
    ...
    vm.$nextTick((_) => {
      expect(vm.$el.querySelectorAll('.ac-step__head.is-error')).to.length(1);
      done();
    });
  });
  ...
  it('update processStatus', (done) => {
    ...
    vm.$nextTick((_) => {
      ...
      vm.$nextTick((_) => {
        expect(vm.$el.querySelectorAll('.ac-step__head.is-process')).to.length(
          1
        );
        done();
      });
  ...
  it('active', (done) => {
    ...
    vm.$nextTick((_) => {
      expect(vm.$el.querySelectorAll('.ac-step__head.is-error')).to.length(0);
      vm.active = 2;
      vm.$nextTick((_) => {
        expect(vm.$el.querySelectorAll('.ac-step__head.is-error')).to.length(2);
        done();
      });
    });
  });
