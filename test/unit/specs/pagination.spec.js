...
describe('Pagination', () => {
  ...
  it('create', () => {
    ...
    // pager
    expect(elm.querySelector('ul.ac-pager')).to.exist;
    // next
    expect(elm.querySelector('button.btn-next')).to.exist;
    // jumper
    expect(elm.querySelector('.ac-pagination__jump')).to.exist;
    // ->
    expect(elm.querySelector('.ac-pagination__rightwrapper')).to.exist;
  });
  ...
  it('set layout', () => {
    ...
    expect(elm.querySelector('button.btn-next')).to.exist;
    // not found jumper
    expect(elm.querySelector('.ac-pagination__jump')).to.not.exist;
    // not found ->
    expect(elm.querySelector('.ac-pagination__rightwrapper')).to.not.exist;
    // not found total
    expect(elm.querySelector('.ac-pagination__total')).to.not.exist;
  });
  ...
  it('layout: all in right, need clear float', () => {
    ...
    const elm = vm.$el;
    let right_div = elm.querySelector('.ac-pagination__rightwrapper');
  ...
  it('small', () => {
    ...
    expect(vm.$el.classList.contains('ac-pagination--small')).to.true;
  });
  ...
  it('pageSizes', () => {
    ...
    expect(vm.$el.querySelector('.ac-select-dropdown__item.selected'))
      .to.property('textContent')
      .include('35');
    expect(
      [].slice
        .call(vm.$el.querySelectorAll('.ac-select-dropdown__item'))
  ...
  it('event:size-change', (done) => {
    ...
    setTimeout((_) => {
      vm.$el.querySelectorAll('li.ac-select-dropdown__item')[1].click();
      setTimeout((_) => {
  ...
  it('pageSize > total', () => {
    ...
    const input = vm.$el.querySelector('.ac-pagination__jump input');
  ...
  describe('click pager', () => {
    it('click ul', () => {
      ...
      vm.$el.querySelector('.ac-pager').click();
    ...
    it('click li', () => {
      ...
      vm.$el.querySelectorAll('.ac-pager li.number')[1].click();
    ...
    it('click next icon-more', () => {
      ...
      vm.$el.querySelector('.ac-pager .more').click();
