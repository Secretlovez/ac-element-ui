...
describe('Slider', () => {
  ...
  it('show input', (done) => {
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.ac-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.ac-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.ac-slider__stop');
  ...
  describe('range', () => {
    ...
    it('marks', async () => {
      ...
      const stops = vm.$el.querySelectorAll(
        '.ac-slider__marks-stop.ac-slider__stop'
      );
      const marks = vm.$el.querySelectorAll(
        '.ac-slider__marks .ac-slider__marks-text'
      );
